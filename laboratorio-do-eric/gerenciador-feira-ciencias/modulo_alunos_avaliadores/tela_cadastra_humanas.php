            ...
            <div class="content">
              <article>
                <?php
                  ...
                  $sql_code_2 = "SELECT * FROM tbl_projet_dados WHERE area_tbl_projeto_dados='humanas'";
                ...
                <div class="amostra-projetos">
                  <a href="tela_exibicao_projeto.php?id_consulta=<?php echo $linha['id_tbl_projet_dados']?>&area=humanas">
