...
<html>
  <head>
    <meta charset="utf-8">
    <title>Cadastro de projetos de Linguagens</title>
    <link href="https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700" rel="stylesheet">
    <link rel="stylesheet" href="css/menu.css">
    <link rel="shortcut icon" href="img/iconLing.png">
  </head>
  <body>
            ...
            <div class="content">
              <article>
                <?php
                  ...
                  $sql_code_2 = "SELECT * FROM tbl_projet_dados WHERE area_tbl_projeto_dados='linguagens'";
                ...
                <div class="amostra-projetos">
                  <a href="tela_exibicao_projeto.php?id_consulta=<?php echo $linha['id_tbl_projet_dados']?>&area=linguagens">
