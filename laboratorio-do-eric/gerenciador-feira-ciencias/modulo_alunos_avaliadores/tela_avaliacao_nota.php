  ...
  <body>
    <div class="corpo">
      <nav class="nav-tabs">
        <ul>
          <li>
            <a href="<?php echo'tela_avaliacao_'.$area.".php"?>">Voltar</a>
              ...
              <article>
                <form class="" action="php/cadastrar.php" method="post">
                  <table border="1">
                    ...
                    <tr>
                      <td colspan="2"><img src="<?php echo 'php/upload_img/'.$linha['nomeImg_tbl_projeto_dados']?>" alt="" width="300" heigth="300">
                    </tr>
                    <tr>
                      <td><input type="reset" name="" value="Limpar" class="btn-home"></td>
                      <td><input type="submit" name="" value="Enviar" class="btn-home"></td>
                    </tr>
                  </table>
                </form>
              </article>
